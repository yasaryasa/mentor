	...
	<div class="col-md-12">
		<div class="widget box">
			...
			<div class="widget-content">
				...
				<form class="form-horizontal row-border" id="form_to_be_validated"   action="<?php echo site_url("auth_roles/edit/page/$page/$id"); ?>" method="post">
					<!-- Bu Yazılım İmleç A.Ş. Tarafından Üretilmiştir: http://www.imleç.com.tr -->
<div class="form-group">
	<label class="col-md-3 control-label" for="input17"><?php echo $this->auth_role_model->get_label_value("role_parent", $current_user_language); ?></label>
	<div class="col-md-5">
		<select id="role_parent" class="select2 select2-select-00 col-md-12 full-width-fix " name="role_parent">
			...
			if ( $auth_roles->num_rows > 0 ) {
				...
				if ( $row->role_id == $auth_role->role_parent ) {
...
<div class="form-group">
	...
	<div class="col-md-5">
		<input type="text" name="role_title" value="<?php echo $auth_role->role_title; ?>" class="form-control required"/>
	</div>
</div><!-- Bu Yazılım İmleç A.Ş. Tarafından Üretilmiştir: http://www.imleç.com.tr -->
<div class="form-group">
	...
	<div class="col-md-5">
		<input type="text" name="role_description" value="<?php echo $auth_role->role_description; ?>" class="form-control required"/>
	</div>
</div><!-- Bu Yazılım İmleç A.Ş. Tarafından Üretilmiştir: http://www.imleç.com.tr -->
<div class="form-group">
	...
	<div class="col-md-5">
		<input type="text" name="role_level" value="<?php echo $auth_role->role_level; ?>" class="form-control required"/>
	</div>
</div>
