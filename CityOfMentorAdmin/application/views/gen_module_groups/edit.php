	...
	<div class="col-md-12">
		<div class="widget box">
			...
			<div class="widget-content">
				...
				<form class="form-horizontal row-border" id="form_to_be_validated"   action="<?php echo site_url("gen_module_groups/edit/page/$page/$id"); ?>" method="post">
					<!-- Bu Yazılım İmleç A.Ş. Tarafından Üretilmiştir: http://www.imleç.com.tr -->
<div class="form-group">
	...
	<div class="col-md-5">
		<input type="text" name="module_group_title" value="<?php echo $gen_module_group->module_group_title; ?>" class="form-control required"/>
	</div>
...
<div class="form-group">
	...
	<div class="col-md-5">
		<input type="text" name="module_group_order" value="<?php echo $gen_module_group->module_group_order; ?>" class="form-control required"/>
	</div>
</div><!-- Bu Yazılım İmleç A.Ş. Tarafından Üretilmiştir: http://www.imleç.com.tr -->
<div class="form-group">
	<label class="col-md-3 control-label" for="input17"><?php echo $this->gen_module_group_model->get_label_value("module_group_position", $current_user_language); ?><span class="required">*</span></label>
	<div class="col-md-5">
		<select id="module_group_position" class="select2 select2-select-00 col-md-12 full-width-fix required" name="module_group_position">
			...
			if ( $gen_module_positions->num_rows > 0 ) {
				...
				if ( $row->module_position_id == $gen_module_group->module_group_position ) {
