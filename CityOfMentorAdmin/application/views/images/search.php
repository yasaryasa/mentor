...
<?php } ?>
							...
							<th width="90"><?php echo $this->image_model->get_label_value("administration", $current_user_language); ?></th>
						</tr>
						</tr>
					</thead>
					<tbody>
...
<?php
	...
	echo $this->image_model->get_label_value("there_is_no_images_item_with_term", $current_user_language);
}
?>
