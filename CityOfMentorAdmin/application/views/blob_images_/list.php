			...
			<div class="widget-content no-padding">
				<table class="table table-striped table-bordered table-hover">
					<thead>
						<tr>
							<!-- Bu Yazılım İmleç A.Ş. Tarafından Üretilmiştir: http://www.imleç.com.tr -->
							<th><a hred=""><?php echo $this->blob_image_model->get_label_value("id", $current_user_language); ?>
							</a></th>
							<!-- Bu Yazılım İmleç A.Ş. Tarafından Üretilmiştir: http://www.imleç.com.tr -->
							<th><a hred=""><?php echo $this->blob_image_model->get_label_value("name", $current_user_language); ?>
							</a></th>
							<!-- Bu Yazılım İmleç A.Ş. Tarafından Üretilmiştir: http://www.imleç.com.tr -->
							<th><a hred=""><?php echo $this->blob_image_model->get_label_value("data", $current_user_language); ?>
							</a></th>
							<!-- Bu Yazılım İmleç A.Ş. Tarafından Üretilmiştir: http://www.imleç.com.tr -->
							<?php if ( $this->blob_image_model->get_read("entries") && ( $this->blob_image_model->get_see_others("entries") ||  $this->blob_image_model->get_see_all("entries")  ||  $this->blob_image_model->get_create("entries") )  ) { ?>
							...
							<!-- Bu Yazılım İmleç A.Ş. Tarafından Üretilmiştir: http://www.imleç.com.tr -->
							<?php if ( $this->blob_image_model->get_read("auth_users") && ( $this->blob_image_model->get_see_others("auth_users") ||  $this->blob_image_model->get_see_all("auth_users")  ||  $this->blob_image_model->get_create("auth_users") )  ) { ?>
							<th><a hred=""><?php echo $this->blob_image_model->get_label_value("blob_image_owner", $current_user_language); ?>
							</a></th>
							<?php } ?>

							<th width="100"><?php echo $this->blob_image_model->get_label_value("administration", $current_user_language); ?>
							</th>
						</tr>
					</thead>
					<tbody>
						...
						<tr>
							<!-- Bu Yazılım İmleç A.Ş. Tarafından Üretilmiştir: http://www.imleç.com.tr -->
							<td><?php echo  character_limiter( $row->id,35); ?></td>
							<!-- Bu Yazılım İmleç A.Ş. Tarafından Üretilmiştir: http://www.imleç.com.tr -->
							<td><?php echo  character_limiter( $row->name,35); ?></td>
							<!-- Bu Yazılım İmleç A.Ş. Tarafından Üretilmiştir: http://www.imleç.com.tr -->
							<td><img
								src="<?php echo site_url("blob_images/get_image/".$row->id); ?>"
								width="40" /></td>
							<!-- Bu Yazılım İmleç A.Ş. Tarafından Üretilmiştir: http://www.imleç.com.tr -->
							<?php if ( $this->blob_image_model->get_read("entries") && ( $this->blob_image_model->get_see_others("entries") ||  $this->blob_image_model->get_see_all("entries")  ||  $this->blob_image_model->get_create("entries") )  ) { ?>
...
<ul
	...
	echo "<li><a href='".site_url("blob_images/index/page/".$previous."/entry/".$entry."/auth_user/".$auth_user."/")."'> &larr; önceki </a></li>";
	while ( $i <= $page_count ) {
		if ( $i == 1 ) {
			if ( $i == $page )
				echo "<li class='active'><a href='".site_url("blob_images/index/page/".$i."/entry/".$entry."/auth_user/".$auth_user."/")."'>ilk</a></li>";
			else
				echo "<li><a href='".site_url("blob_images/index/page/".$i."/entry/".$entry."/auth_user/".$auth_user."/")."'>ilk</a></li>";
		}
		...
		if ( $i == $page_count && $page_count != 1 ) {
			if ( $i == $page )
				echo "<li class='active'><a href='".site_url("blob_images/index/page/".$i."/entry/".$entry."/auth_user/".$auth_user."/")."'>son</a></li>";
			else
				echo "<li><a href='".site_url("blob_images/index/page/".$i."/entry/".$entry."/auth_user/".$auth_user."/")."'>son</a></li>";
		}
		$i++;
	}
	echo "<li><a href='".site_url("blob_images/index/page/".$next."/entry/".$entry."/auth_user/".$auth_user."/")."'> sonraki &rarr; </a></li>";
	?>
