					...
					<div class="form-group">
						...
						<div class="col-md-5">
							<input type="text" name="name"
								value="<?php echo $blob_image->name; ?>" class="form-control required" />
						</div>
					</div>
					<!-- Bu Yazılım İmleç A.Ş. Tarafından Üretilmiştir: http://www.imleç.com.tr -->
					<?php
					if (empty($blob_image->path )) {
						?>
					<div class="form-group">
						<label class="col-md-3 control-label"><?php echo $this->blob_image_model->get_label_value("path", $current_user_language); ?>
						<span class="required">*</span></label>
					...
					<div class="form-group" id="file_upload_div">
						...
						<div class="col-md-9" id="area">
							<div class="jc-demo-box">
								...
								</a> <img src="<?php echo base_url().$blob_image->path; ?>"
