	...
	<div class="col-md-12">
		<div class="widget box">
			...
			<div class="widget-content">
				...
				<form class="form-horizontal row-border" id="form_to_be_validated"   action="<?php echo site_url("gen_image_settings/edit/page/$page/$id"); ?>" method="post">
					<!-- Bu Yazılım İmleç A.Ş. Tarafından Üretilmiştir: http://www.imleç.com.tr -->
<div class="form-group">
	<label class="col-md-3 control-label" for="input17"><?php echo $this->gen_image_setting_model->get_label_value("setting_module_name", $current_user_language); ?><span class="required">*</span></label>
	<div class="col-md-5">
		<select id="setting_module_name" class="select2 select2-select-00 col-md-12 full-width-fix required" name="setting_module_name">
			...
			if ( $gen_modules->num_rows > 0 ) {
				...
				if ( $row->module_title == $gen_image_setting->setting_module_name ) {
...
<div class="form-group">
	<label class="col-md-3 control-label" for="input17"><?php echo $this->gen_image_setting_model->get_label_value("setting_type_id", $current_user_language); ?><span class="required">*</span></label>
	<div class="col-md-5">
		<select id="setting_type_id" class="select2 select2-select-00 col-md-12 full-width-fix required" name="setting_type_id">
			...
			if ( $gen_image_setting_types->num_rows > 0 ) {
				...
				if ( $row->type_id == $gen_image_setting->setting_type_id ) {
...
<div class="form-group">
	...
	<div class="col-md-5">
		<input type="text" name="setting_image_width" value="<?php echo $gen_image_setting->setting_image_width; ?>" class="form-control "/>
	</div>
</div><!-- Bu Yazılım İmleç A.Ş. Tarafından Üretilmiştir: http://www.imleç.com.tr -->
<div class="form-group">
	...
	<div class="col-md-5">
		<input type="text" name="setting_image_height" value="<?php echo $gen_image_setting->setting_image_height; ?>" class="form-control "/>
	</div>
</div>
