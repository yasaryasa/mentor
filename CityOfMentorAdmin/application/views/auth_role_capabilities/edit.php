	...
	<div class="col-md-12">
		<div class="widget box">
			...
			<div class="widget-content">
				...
				<form class="form-horizontal row-border" id="form_to_be_validated"   action="<?php echo site_url("auth_role_capabilities/edit/page/$page/$id"); ?>" method="post">
					<!-- Bu Yazılım İmleç A.Ş. Tarafından Üretilmiştir: http://www.imleç.com.tr -->
<div class="form-group">
	<label class="col-md-3 control-label" for="input17"><?php echo $this->auth_role_capability_model->get_label_value("role_capability_role_id", $current_user_language); ?><span class="required">*</span></label>
	<div class="col-md-5">
		<select id="role_capability_role_id" class="select2 select2-select-00 col-md-12 full-width-fix required" name="role_capability_role_id">
			...
			if ( $auth_roles->num_rows > 0 ) {
				...
				if ( $row->role_id == $auth_role_capability->role_capability_role_id ) {
...
<div class="form-group">
	<label class="col-md-3 control-label" for="input17"><?php echo $this->auth_role_capability_model->get_label_value("role_capability_module_name", $current_user_language); ?><span class="required">*</span></label>
	<div class="col-md-5">
		<select id="role_capability_module_name" class="select2 select2-select-00 col-md-12 full-width-fix required" name="role_capability_module_name">
			...
			if ( $gen_modules->num_rows > 0 ) {
				...
				if ( $row->module_title == $auth_role_capability->role_capability_module_name ) {
...
<div class="form-group">
	...
	<div class="col-md-5">
		<input type="text" name="role_capability_see_all" value="<?php echo $auth_role_capability->role_capability_see_all; ?>" class="form-control "/>
	</div>
</div><!-- Bu Yazılım İmleç A.Ş. Tarafından Üretilmiştir: http://www.imleç.com.tr -->
<div class="form-group">
	...
	<div class="col-md-5">
		<input type="text" name="role_capability_see_others" value="<?php echo $auth_role_capability->role_capability_see_others; ?>" class="form-control "/>
	</div>
</div><!-- Bu Yazılım İmleç A.Ş. Tarafından Üretilmiştir: http://www.imleç.com.tr -->
<div class="form-group">
	...
	<div class="col-md-5">
		<input type="text" name="role_capability_show" value="<?php echo $auth_role_capability->role_capability_show; ?>" class="form-control "/>
	</div>
</div><!-- Bu Yazılım İmleç A.Ş. Tarafından Üretilmiştir: http://www.imleç.com.tr -->
<div class="form-group">
	...
	<div class="col-md-5">
		<input type="text" name="role_capability_create" value="<?php echo $auth_role_capability->role_capability_create; ?>" class="form-control "/>
	</div>
</div><!-- Bu Yazılım İmleç A.Ş. Tarafından Üretilmiştir: http://www.imleç.com.tr -->
<div class="form-group">
	...
	<div class="col-md-5">
		<input type="text" name="role_capability_read" value="<?php echo $auth_role_capability->role_capability_read; ?>" class="form-control "/>
	</div>
</div><!-- Bu Yazılım İmleç A.Ş. Tarafından Üretilmiştir: http://www.imleç.com.tr -->
<div class="form-group">
	...
	<div class="col-md-5">
		<input type="text" name="role_capability_update" value="<?php echo $auth_role_capability->role_capability_update; ?>" class="form-control "/>
	</div>
</div><!-- Bu Yazılım İmleç A.Ş. Tarafından Üretilmiştir: http://www.imleç.com.tr -->
<div class="form-group">
	...
	<div class="col-md-5">
		<input type="text" name="role_capability_delete" value="<?php echo $auth_role_capability->role_capability_delete; ?>" class="form-control "/>
	</div>
</div>
