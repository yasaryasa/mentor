		...
		<div class="widget box">
			...
			<div class="widget-content">
				...
				<form class="form-horizontal row-border" id="form_to_be_validated"
					action="<?php echo site_url("category_entries/edit/page/$page/$id"); ?>"
					method="post">
					
					<div class="form-group">
						<label class="col-md-3 control-label" for="input17"><?php echo $this->category_entry_model->get_label_value("entry_id", $current_user_language); ?>
							...
							<select id="entry_id"
								...
								if ( $entries->num_rows > 0 ) {
									foreach ( $entries->result() as $row ) {
										if ( $row->id == $category_entry->entry_id ) {
					...
					<div class="form-group">
						<label class="col-md-3 control-label" for="input17"><?php echo $this->category_entry_model->get_label_value("category_id", $current_user_language); ?>
						<span class="required">*</span></label>
						<div class="col-md-5">
							<select id="category_id"
								...
								if ( $categories->num_rows > 0 ) {
									foreach ( $categories->result() as $row ) {
										if ( $row->id == $category_entry->category_id ) {
