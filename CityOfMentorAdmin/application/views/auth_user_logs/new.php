	...
	<div class="col-md-12">
		<div class="widget box">
			...
			<div class="widget-content">
				...
				<form class="form-horizontal row-border" id="form_to_be_validated"   action="<?php echo site_url("auth_user_logs/create"); ?>" method="post">
					<!-- Bu Yazılım İmleç A.Ş. Tarafından Üretilmiştir: http://www.imleç.com.tr -->
<div class="form-group">
	...
	<div class="col-md-5">
		<input type="text" name="user_log_ip_address" value="" class="form-control required"/>
	</div>
...
<div class="form-group">
	...
	<div class="col-md-5">
		<textarea name="user_log_activity" class="form-control wysiwyg" rows="15"></textarea></textarea>
	</div>
</div><!-- Bu Yazılım İmleç A.Ş. Tarafından Üretilmiştir: http://www.imleç.com.tr -->
<div class="form-group">
	...
	<div class="col-md-5">
		<input type="text" name="user_log_user_agent" value="" class="form-control required"/>
	</div>
</div>
<!-- Bu Yazılım İmleç A.Ş. Tarafından Üretilmiştir: http://www.imleç.com.tr -->
<div class="form-group">
	...
	<div class="col-md-5">
		<input type="text" name="user_log_time" value="" class="form-control datepicker required" data-mask="99-99-9999"/>
	</div>
</div>
