	...
	<div class="col-md-12">
		<div class="widget box">
			...
			<div class="widget-content">
				...
				<form class="form-horizontal row-border" id="form_to_be_validated"   action="<?php echo site_url("gen_languages/create"); ?>" method="post">
					<!-- Bu Yazılım İmleç A.Ş. Tarafından Üretilmiştir: http://www.imleç.com.tr -->
<div class="form-group">
	...
	<div class="col-md-5">
		<input type="text" name="language_title" value="" class="form-control required"/>
	</div>
...
<div class="form-group">
	...
	<div class="col-md-5">
		<input type="text" name="language_short" value="" class="form-control "/>
	</div>
</div>
<!-- Bu Yazılım İmleç A.Ş. Tarafından Üretilmiştir: http://www.imleç.com.tr -->
<div class="form-group">
	...
	<div class="col-md-5">
		<input type="text" name="language_created" value="" class="form-control datepicker " data-mask="99-99-9999"/>
	</div>
</div>
<!-- Bu Yazılım İmleç A.Ş. Tarafından Üretilmiştir: http://www.imleç.com.tr -->
<div class="form-group">
	...
	<div class="col-md-5">
		<input type="text" name="language_modified" value="" class="form-control datepicker " data-mask="99-99-9999"/>
	</div>
</div>
