			...
			<div class="widget-content">
				...
				<form class="form-horizontal row-border" id="form_to_be_validated"
					...
					<div class="form-group">
						...
						<div class="col-md-5">
							<input type="text" name="map_lat" id="map_lat" value="" class="form-control " />
						</div>
					</div>
					<!-- Bu Yazılım İmleç A.Ş. Tarafından Üretilmiştir: http://www.imleç.com.tr -->
					<div class="form-group">
						...
						<div class="col-md-5">
							<input type="text" name="map_long" id="map_long" value="" class="form-control " />
						</div>
					</div>
					<!-- Bu Yazılım İmleç A.Ş. Tarafından Üretilmiştir: http://www.imleç.com.tr -->
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-md-5">
							<input type="text" name="posted_date" disabled value="<?php echo date("d-m-Y");?>"
