	...
	<div class="col-md-12">
		<div class="widget box">
			...
			<div class="widget-content">
				...
				<form class="form-horizontal row-border" id="form_to_be_validated"   action="<?php echo site_url("gen_labels/edit/page/$page/$id"); ?>" method="post">
					<!-- Bu Yazılım İmleç A.Ş. Tarafından Üretilmiştir: http://www.imleç.com.tr -->
<div class="form-group">
	<label class="col-md-3 control-label" for="input17"><?php echo $this->gen_label_model->get_label_value("label_language_id", $current_user_language); ?></label>
	<div class="col-md-5">
		<select id="label_language_id" class="select2 select2-select-00 col-md-12 full-width-fix " name="label_language_id">
			...
			if ( $gen_languages->num_rows > 0 ) {
				...
				if ( $row->language_id == $gen_label->label_language_id ) {
...
<div class="form-group">
	...
	<div class="col-md-5">
		<input type="text" name="label_name" value="<?php echo $gen_label->label_name; ?>" class="form-control required"/>
	</div>
</div><!-- Bu Yazılım İmleç A.Ş. Tarafından Üretilmiştir: http://www.imleç.com.tr -->
<div class="form-group">
	...
	<div class="col-md-5">
		<input type="text" name="label_value" value="<?php echo $gen_label->label_value; ?>" class="form-control required"/>
	</div>
</div>
